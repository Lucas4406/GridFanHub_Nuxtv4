...
<template>
  <UPageHeader title="Latest News" description="Stay updated with the latest news articles." class="mb-4" />
  <UBlogPosts>
        <UBlogPost
          ...
          :to="`https://formula1.com/en/latest/article/${article.slug}.${article.id}`"
          target="_blank"
          :authors="authors"
